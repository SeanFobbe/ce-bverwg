...
{ \scshape \Huge \bfseries Corpus der Entscheidungen \\[0.5cm] \Huge \bfseries \scshape des \\[0.5cm] \Huge \bfseries \scshape Bundesverwaltungsgerichts \\[0.5cm] \LARGE \bfseries (\datashort )};
