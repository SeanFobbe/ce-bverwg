...
```{r, pipeline-graph1, fig.width = 7, fig.height = 9, eval = FALSE, echo = FALSE}

#alternative viz
ggraph(g,
       'sugiyama') + 

    geom_edge_diagonal(aes(end_cap = label_rect(node2.name)), 
...
sum(meta$MB) # Gesamter Speicherplatzverbrauch
