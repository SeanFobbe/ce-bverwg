...
```{r, CE-BVerwG_00_Pipeline_Graph, width = 12, height = 9, fig.cap = "Der vollständige Prozess der Datensatz-Kompilierung."}
...
```{r, CE-BVerwG_04_Barplot_Spruchkoerper_AZ, fig.height = 6, fig.width = 9}
...
```{r, CE-BVerwG_05_Barplot_Registerzeichen, fig.height = 8, fig.width = 10}
...
```{r, CE-BVerwG_05_Barplot_VizePraesidentIn, fig.height = 6, fig.width = 9}
...
```{r, CE-BVerwG_06_Barplot_Entscheidungsjahr, fig.height = 6, fig.width = 9}
...
```{r, CE-BVerwG_07_Barplot_EingangsjahrISO, fig.height = 6, fig.width = 9}
