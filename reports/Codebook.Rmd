...
```{r, CE-BVerwG_Pipeline_Graph, fig.width = 12, fig.height = 14, fig.pos = "p", fig.cap = "Der vollständige Prozess der Datensatz-Kompilierung."}
...
```{r, CE-BVerwG_Density_Zeichen, fig.height = 6, fig.width = 9}
...
```{r,  CE-BVerwG_Density_Tokens, fig.height = 6, fig.width = 9}
ggplot(data = dt.bverwg.meta)+
...
```{r, CE-BVerwG_Density_Typen, fig.height = 6, fig.width = 9}
ggplot(data = dt.bverwg.meta)+
...
```{r, CE-BVerwG_Density_Saetze, fig.height = 6, fig.width = 9}
ggplot(data = dt.bverwg.meta)+
...
```{r, CE-BVerwG_Barplot_Entscheidungstyp, fig.height = 6, fig.width = 9}
...
```{r, CE-BVerwG_Barplot_Spruchkoerper_AZ, fig.height = 6, fig.width = 9}
...
```{r, CE-BVerwG_Barplot_Registerzeichen, fig.height = 8, fig.width = 10}
...
```{r, CE-BVerwG_Barplot_PraesidentIn, fig.height = 6, fig.width = 9}
...
```{r, CE-BVerwG_Barplot_VizePraesidentIn, fig.height = 6, fig.width = 9}
...
```{r, CE-BVerwG_Barplot_Entscheidungsjahr, fig.height = 6, fig.width = 9}
...
```{r, CE-BVerwG_Barplot_EingangsjahrISO, fig.height = 6, fig.width = 9}
